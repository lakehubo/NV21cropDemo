...
public class CameraHelper implements Camera.PreviewCallback {
    ...
    public void start() {
        synchronized (this) {
            ...
            try {
                ...
                Log.e(TAG, "start: " + previewSize.width + "," + previewSize.height);
                ...
                int lineBytes = previewSize.width * ImageFormat.getBitsPerPixel(ImageFormat.NV21) / 8;
                mCamera.addCallbackBuffer(new byte[lineBytes * previewSize.height]);
                mCamera.addCallbackBuffer(new byte[lineBytes * previewSize.height]);
                mCamera.addCallbackBuffer(new byte[lineBytes * previewSize.height]);
    ...
    public void onPreviewFrame(byte[] nv21, Camera camera) {
        ...
        if (mCamera != null)
            mCamera.addCallbackBuffer(nv21);
    }
...
//            start();
    ...
    public static final class Builder {
        ...
        private CropSurfaceView previewDisplayView2;
        /**
